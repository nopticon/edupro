...
//<![CDATA[
function validar() {
	if (!confirm("Seguro que desea guardar la nueva area ocupacional..."))
	{
		return false;
	}
...
<div id="content" class="float-holder">
	...
	<div class="blue">
		...
		<form action="cod_ocupacional.php" method="post" onsubmit="return validar();">
		...
		?>
			<table width="100%" border="0">
				<tr>
					...
					<td width="75%" align="left"><?php echo $arreglo['nombre_ocupacion']; ?></td>
				</tr>
			</table>
		<?php
		}
