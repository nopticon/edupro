        ...
        <tr>
          ...
          <td width="809"><div align="right">
            ...
            <table width="821" align="center">
              <tr>
                <td width="806" bgcolor="#4682B4"><div class="title"> Mantenimiento de Tiempo de Examenes </div></td>
              </tr>
              <tr bgcolor="#F3F3F3">
                <td bordercolor="#000000" bgcolor="#F3F3F3"><br />
                  <table width="812" border="0">
                    <tr>
                      <td width="71">&nbsp;</td>
                      <td width="38">&nbsp;</td>
                      <td width="441"><div align="center" class="Estilo6">Nombre de Tiempo </div></td>
                  ...
                  <table width="812" border="0">
                    <tr>
                      ...
                      <td width="441"><a href="tiempo.php?id_examen=<?php echo $arreglo['id_examen']; ?>"><?php echo $arreglo['examen']; ?></a></td>
                      <td width="90" class="Estilo11"><div align="center"><a href="#"><img src="../../images/iconos/104.ico" border="0" /></a></div></td>
                    </tr>
                  </table>
                  <?php }?><br />
                  <br />
